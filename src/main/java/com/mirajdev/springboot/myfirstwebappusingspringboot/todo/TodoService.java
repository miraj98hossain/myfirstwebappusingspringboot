...
public class TodoService {
    ...
    static {
        todos.add(
                new Todo(++todoCount, "mirajhossain98", "Learn AWS", LocalDate.now().plusYears(1), false));
        todos.add(
                new Todo(++todoCount, "mirajhossain", "Learn AWS", LocalDate.now().plusYears(2), false));
        todos.add(
                new Todo(++todoCount, "mirajhossain", "Learn AWS", LocalDate.now().plusYears(3), false));
    }
